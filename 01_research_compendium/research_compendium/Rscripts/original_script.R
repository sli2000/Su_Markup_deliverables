...
# read data:
d1 <- sasxport.get("raw_data/DEMO_I.xpt")
d2 <- sasxport.get("raw_data/BPX_I.xpt")
d3 <- sasxport.get("raw_data/BMX_I.xpt")
d4 <- sasxport.get("raw_data/GHB_I.xpt")
d5 <- sasxport.get("raw_data/TCHOL_I.xpt")
...
FIGURE
ggsave(filename = "results/Figure_STRATOS.tif", 
       plot = FIGURE, 
       device = "tiff", 
       width = 8, 
       height = 6, 
