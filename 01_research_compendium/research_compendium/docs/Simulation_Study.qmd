...
# read data:
d1 <- Hmisc::sasxport.get("../raw_data/DEMO_I.XPT")
d2 <- Hmisc::sasxport.get("../raw_data/BPX_I.xpt")
d3 <- Hmisc::sasxport.get("../raw_data/BMX_I.xpt")
d4 <- Hmisc::sasxport.get("../raw_data/GHB_I.xpt")
d5 <- Hmisc::sasxport.get("../raw_data/TCHOL_I.xpt")
